 ...
 *   // => { coverage: 1, notCoveredFields: []}
 *   module.exports('DeeplyNestedObjectWithPartialNoFollow', require('../test/unit/mockData'))
 *   // => { coverage: 0.5, notCoveredFields: ["DeeplyNestedObject___NOFollowPart", "DeeplyNestedObject___DeeplyNestedObject___DeepNest", "DeeplyNestedObject___ObjectField___NotSoDeepNest"]}
 */
module.exports = function coverageCalculator (rootName, schema) {
  ...
  return {
    coverage: allQuerableFields.length / allAllFields.length,
